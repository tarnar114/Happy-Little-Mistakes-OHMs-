...
<h1 class="w3-display-middle w3-animate-opacity">
    <ul type="none" style="align-items: center">
        ...
        <li><a href="landscape.php?category=<?php ['Id'] ?>">Landscape</a></li>
        <li><a href="portrait.php?category=<?php ['Id'] ?>">Portrait</a></li>
        <li><a href="recentlyuploaded.php?category=<?php ['Id'] ?>">Recently Uploaded</a></li>
    </ul>
</h1>