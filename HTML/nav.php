...
<header class="sticky-top">
    <div class="container w3-animate-opacity">
        ...
        <nav class="navbar navbar-light">
            ...
            <nav class="dropbtn">
                ...
                <!-- Menu Button -->
                <button class="navbutton" type="menu" data-toggle="collapse" data-target="#navitems"><span
    ...
    <a class="uploadbtn" type="button" href="../PHP/uploadPage.php">
        <img src="../Images/round_post_add_black_18dp.png" alt="Upload">
    </a>
    <!-- Floarting user pprofile button @ bottom corner of page -->
    <a class="profilebtn" type="button" href="../PHP/userProfile.php">
